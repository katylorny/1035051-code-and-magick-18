...
(function () {
  ...
  var coatInput = window.util.setup.querySelector('input[name="coat-color"]');
  var wizardEyes = window.setupE.setupWizard.querySelector('.wizard-eyes');
  var eyesInput = window.util.setup.querySelector('input[name="eyes-color"]');
  var wizardFireball = window.util.setup.querySelector('.setup-fireball-wrap');
  var fireballColors = ['#ee4830', '#30a8ee', '#5ce6c0', '#e848d5', '#e6e848'];
  var fireballInput = window.util.setup.querySelector('input[name="fireball-color"]');
